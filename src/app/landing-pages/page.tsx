...
export default function LandingPagesSalesPage() {
  return (
    <main data-landing-page className="min-h-screen overflow-x-hidden bg-[#f7f6f2] pb-24 text-[#102d2b] sm:pb-0">
      <LandingMotion />
      ...
      <section id="inicio" className="lp-hero mx-auto grid max-w-6xl items-center gap-12 px-5 py-16 sm:px-8 sm:py-24 lg:grid-cols-[1.03fr_.97fr] lg:py-28">
        <div>
      ...
      <section data-lp-reveal className="border-y border-[#173f3b]/10 bg-white/60">
      ...
      <section data-lp-reveal id="solucoes" className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-3">
          {solutions.map((solution, index) => (
            <article key={solution.title} className={`lp-card rounded-2xl border p-6 sm:p-7 ${index === 1 ? "border-[#0b7769] bg-[#153f3a] text-white" : "border-[#173f3b]/12 bg-white"}`}>
      ...
      <section data-lp-reveal id="projetos" className="bg-[#153f3a] py-20 text-white sm:py-28">
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          ...
          <div className="mt-10 grid gap-x-5 gap-y-8 sm:grid-cols-2 lg:grid-cols-3">
            {proofProjects.slice(1, 7).map((project) => (
              <article key={project.image} className="lp-card">
      ...
      <section data-lp-reveal id="processo" className="mx-auto grid max-w-6xl gap-12 px-5 py-20 sm:px-8 sm:py-28 lg:grid-cols-[.8fr_1.2fr]">
        <div>
        ...
        <ol className="border-t border-[#173f3b]/15">
          {steps.map(([number, title, description]) => (
            <li key={number} className="lp-card grid gap-2 border-b border-[#173f3b]/15 py-6 sm:grid-cols-[3rem_.7fr_1.3fr] sm:gap-4">
      ...
      <section data-lp-reveal className="border-y border-[#173f3b]/10 bg-white py-20 sm:py-24">
      ...
      <section data-lp-reveal className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-24">
        <div className="grid gap-5 lg:grid-cols-3">
          {[
            ...
            <article key={title} className="lp-card rounded-2xl border border-[#173f3b]/12 bg-white p-6">
      ...
      <section data-lp-reveal id="orcamento" className="border-y border-[#173f3b]/10 bg-[#eaf0ec] py-20 sm:py-24">
      ...
      <section data-lp-reveal className="mx-auto max-w-4xl px-5 pb-20 sm:px-8 sm:pb-28">
      ...
      <section data-lp-reveal className="px-5 pb-6 sm:px-8">
